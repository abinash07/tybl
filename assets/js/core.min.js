!function(s) {
    ...
    s.fn.menumaker = function(t) {
        ...
        return this.each(function() {
            ...
            return s(this).find(".navbar-toggler").on("click", function() {
    ...
    f.fn.extend({
        easyResponsiveTabs: function(l) {
            ...
            this.each(function() {
                ...
                s.find(".resp-tabs-container." + l.tabidentify).css("border-color", l.active_content_border_color),
                s.find(".resp-tabs-container." + l.tabidentify + " > div").addClass("resp-tab-content").addClass(l.tabidentify),
                "vertical" == h && s.addClass("resp-vtabs").addClass(l.tabidentify),
                1 == d && s.css({
                    width: "100%",
                    margin: "0px"
                }),
                "accordion" == h && (s.addClass("resp-easy-accordion").addClass(l.tabidentify),
                ...
                var r, a = 0;
                "" == u || null !== (r = u.match(new RegExp(o + "([0-9]+)"))) && 2 === r.length && (a = parseInt(r[1], 10) - 1,
                e < a && (a = 0)),
                f(s.find(".resp-tab-item." + l.tabidentify)[a]).addClass("resp-tab-active").css({
                ...
                f(s.find(".resp-tab-content." + l.tabidentify)[a]).addClass("resp-tab-content-active").addClass(l.tabidentify).attr("style", "display:block")),
                s.find("[role=tab]").each(function() {
                    f(this).on("click", function() {
                        ...
                        if (e.hasClass("resp-accordion") && e.hasClass("resp-tab-active"))
                            ...
                            !1;
                        !e.hasClass("resp-tab-active") && e.hasClass("resp-accordion") ? (s.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}),
                        s.find(".resp-tab-content-active." + l.tabidentify).slideUp().removeClass("resp-tab-content-active resp-accordion-closed"),
                        s.find("[aria-controls=" + i + "]").addClass("resp-tab-active").css({}),
                        s.find(".resp-tab-content[aria-labelledby = " + i + "]." + l.tabidentify).slideDown().addClass("resp-tab-content-active")) : (s.find(".resp-tab-active." + l.tabidentify).removeClass("resp-tab-active").css({}),
                        ...
                        s.find("[aria-controls=" + i + "]").addClass("resp-tab-active").css({}),
                        s.find(".resp-tab-content[aria-labelledby = " + i + "]." + l.tabidentify).addClass("resp-tab-content-active").attr("style", "display:block")),
                        e.trigger("tabactivate", e),
                        p && (t = window.location.hash,
                        i.split("tab_item-"),
                        e = (e = "") != t ? (i = new RegExp(o + "[0-9]+"),
...
function(l, i, s, a) {
    ...
    h.prototype.register = function(i) {
        var e;
        i.type === h.Type.Event ? (l.event.special[i.name] || (l.event.special[i.name] = {}),
        l.event.special[i.name].owl || (e = l.event.special[i.name]._default,
        l.event.special[i.name]._default = function(t) {
            return !e || !e.apply || t.namespace && -1 !== t.namespace.indexOf("owl") ? t.namespace && -1 < t.namespace.indexOf("owl") : e.apply(this, arguments)
        }
        ,
        l.event.special[i.name].owl = !0)) : i.type === h.Type.State && (this._states.tags[i.name] ? this._states.tags[i.name] = this._states.tags[i.name].concat(i.tags) : this._states.tags[i.name] = i.tags,
    ...
    l.fn.owlCarousel = function(e) {
        ...
        return this.each(function() {
            ...
            i || (i = new h(this,"object" == typeof e && e),
...
function(d, e) {
    var i = function(t) {
        ...
        this._handlers = {
            ...
            "prepared.owl.carousel": d.proxy(function(t) {
                var e;
                !t.namespace || (e = d(t.content).find(".owl-video")).length && (e.css("display", "none"),
    ...
    i.prototype.thumbnail = function(e, t) {
        ...
        var s, o, n = t.width && t.height ? "width:" + t.width + "px;height:" + t.height + "px;" : "", r = e.find("img"), a = "src", l = "", h = this._core.settings;
        if (e.wrap(d("<div/>", {
    ...
    i.prototype.play = function(t) {
        ...
        (t = d('<iframe frameborder="0" allowfullscreen mozallowfullscreen webkitAllowFullScreen ></iframe>')).attr("height", o),
        t.attr("width", s),
        ...
        d(t).wrap('<div class="owl-video-frame" />').insertAfter(e.find(".owl-video")),
...
function(o, n) {
    ...
    s() && (o.support.animation = new String(h("animation")),
    o.support.animation.end = t.animation.end[o.support.animation]),
    e() && (o.support.transform = new String(h("transform")),
    ...
    i.fn.counterUp = function(t) {
        ...
        return this.each(function() {
            var l = i(this)
              , h = e;
            l.waypoint(function() {
                for (var t = [], e = h.time / h.delay, i = l.text(), s = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), o = (/^[0-9]+$/.test(i),
                ...
                l.data("counterup-func", function() {
                    ...
                    l.data("counterup-nums").length ? setTimeout(l.data("counterup-func"), h.delay) : (l.data("counterup-nums"),
...
function(f, o, t, g) {
    ...
    h.prototype = {
        ...
        _defineElements: function() {
            ...
            this.$element = this.element === o ? f("body") : this.$scrollElement,
            this.$viewportElement = this.options.viewportElement !== g ? f(this.options.viewportElement) : this.$scrollElement[0] === o || "scroll" === this.options.scrollProperty ? this.$scrollElement : this.$scrollElement.parent()
        },
        ...
        refresh: function(t) {
            ...
            t && t.firstLoad && /WebKit/.test(navigator.userAgent) && f(o).on("load", function() {
        ...
        _findParticles: function() {
            ...
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function(t) {
                var e, i, s, o, n, r, a, l = f(this), h = 0, d = 0, c = 0, u = 0;
                ...
                s = l.data("stellar-horizontal-offset") !== g ? l.data("stellar-horizontal-offset") : n !== g && n.data("stellar-horizontal-offset") !== g ? n.data("stellar-horizontal-offset") : p.horizontalOffset,
                o = l.data("stellar-vertical-offset") !== g ? l.data("stellar-vertical-offset") : n !== g && n.data("stellar-vertical-offset") !== g ? n.data("stellar-vertical-offset") : p.verticalOffset,
                p.particles.push({
                    $element: l,
                    $offsetParent: n,
        ...
        _findBackgrounds: function() {
            var t, c = this, u = this._getScrollLeft(), p = this._getScrollTop();
            this.backgrounds = [],
            ...
            t.each(function() {
                var t, e, i, s, o, n = f(this), r = y(n), a = 0, l = 0, h = 0, d = 0;
                ...
                t = n.data("stellar-horizontal-offset") !== g ? n.data("stellar-horizontal-offset") : o !== g && o.data("stellar-horizontal-offset") !== g ? o.data("stellar-horizontal-offset") : c.horizontalOffset,
                e = n.data("stellar-vertical-offset") !== g ? n.data("stellar-vertical-offset") : o !== g && o.data("stellar-vertical-offset") !== g ? o.data("stellar-vertical-offset") : c.verticalOffset,
                c.backgrounds.push({
                    $element: n,
                    $offsetParent: o,
                    ...
                    parentOffsetLeft: a,
                    parentOffsetTop: l,
                    stellarRatio: n.data("stellar-background-ratio") === g ? 1 : n.data("stellar-background-ratio")
                })
            }))
        },
        _reset: function() {
        ...
        destroy: function() {
            ...
            f(o).unbind("load." + this.name).unbind("resize." + this.name)
        },
        ...
        _repositionElements: function() {
            var t, e, i, s, o, n, r, a, l, h, d = this._getScrollLeft(), c = this._getScrollTop(), u = !0, p = !0;
            if (this.currentScrollLeft !== d || this.currentScrollTop !== c || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                for (this.currentScrollLeft = d,
                this.currentScrollTop = c,
                this.currentWidth = this.viewportWidth,
                this.currentHeight = this.viewportHeight,
                h = this.particles.length - 1; 0 <= h; h--)
                    e = (t = this.particles[h]).isFixed ? 1 : 0,
                    a = this.options.horizontalScrolling ? (n = (d + t.horizontalOffset + this.viewportOffsetLeft + t.startingPositionLeft - t.startingOffsetLeft + t.parentOffsetLeft) * -(t.stellarRatio + e - 1) + t.startingPositionLeft) - t.startingPositionLeft + t.startingOffsetLeft : (n = t.startingPositionLeft,
                    t.startingOffsetLeft),
                    l = this.options.verticalScrolling ? (r = (c + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop) - t.startingPositionTop + t.startingOffsetTop : (r = t.startingPositionTop,
                    t.startingOffsetTop),
                    this.options.hideDistantElements && (p = !this.options.horizontalScrolling || a + t.width > (t.isFixed ? 0 : d) && a < (t.isFixed ? 0 : d) + this.viewportWidth + this.viewportOffsetLeft,
                ...
                for (h = this.backgrounds.length - 1; 0 <= h; h--)
                    ...
                    s = this.options.horizontalScrolling ? (d + i.horizontalOffset - this.viewportOffsetLeft - i.startingOffsetLeft + i.parentOffsetLeft - i.startingBackgroundPositionLeft) * (e - i.stellarRatio) + "px" : i.startingValueLeft,
                    o = this.options.verticalScrolling ? (c + i.verticalOffset - this.viewportOffsetTop - i.startingOffsetTop + i.parentOffsetTop - i.startingBackgroundPositionTop) * (e - i.stellarRatio) + "px" : i.startingValueTop,
                    m(i.$element, s, o)
            }
        },
    ...
    f.fn[s] = function(e) {
        ...
        return e === g || "object" == typeof e ? this.each(function() {
            ...
            t instanceof h && "function" == typeof t[e] && t[e].apply(t, Array.prototype.slice.call(i, 1)),
    ...
    i.prototype.handleScroll = function() {
        ...
        for (t in s) {
            ...
            for (o in this.waypoints[t]) {
                ...
                null !== h.triggerPoint && (a = n.oldScroll < h.triggerPoint,
                l = n.newScroll >= h.triggerPoint,
                (a && l || !a && !l) && (h.queueTrigger(r),
    ...
    i.prototype.refresh = function() {
        ...
        t = {
            ...
            for (n in this.waypoints[e]) {
                var a, l = this.waypoints[e][n], h = l.options.offset, d = l.triggerPoint, c = 0, u = null == d;
                l.element !== l.element.window && (c = l.adapter.offset()[r.offsetProp]),
                "function" == typeof h ? h = h.apply(l) : "string" == typeof h && (h = parseFloat(h),
                -1 < l.options.offset.indexOf("%") && (h = Math.ceil(r.contextDimension * h / 100))),
                a = r.contextScroll - r.contextOffset,
                l.triggerPoint = Math.floor(c + a - h),
                a = d < r.oldScroll,
                h = l.triggerPoint >= r.oldScroll,
                d = !a && !h,
                !u && (a && h) ? (l.queueTrigger(r.backward),
                o[l.group.id] = l.group) : (!u && d || u && r.oldScroll >= l.triggerPoint) && (l.queueTrigger(r.forward),
...
function(t) {
    ...
    function p(t) {
        return t === e && f.currTemplate.closeBtn || (f.currTemplate.closeBtn = h(f.st.closeMarkup.replace("%title%", f.st.tClose)),
        e = t),
    ...
    var f, s, g, o, m, e, l = "Close", y = "BeforeClose", v = "MarkupParse", w = "Open", b = ".mfp", _ = "mfp-ready", i = "mfp-removing", r = "mfp-prevent-close", a = !!window.jQuery, x = h(window);
    t.prototype = {
        constructor: t,
        init: function() {
        ...
        open: function(t) {
            ...
            if (!f.isOpen) {
                ...
                u("BeforeOpen"),
                f.st.showCloseBtn && (f.st.closeBtnInside ? (d(v, function(t, e, i, s) {
                    i.close_replaceWith = p(s.type)
                }),
                m += " mfp-close-btn-in") : f.wrap.append(p())),
                ...
                f.st.enableEscapeKey && g.on("keyup" + b, function(t) {
        ...
        _onFocusIn: function(t) {
            return t.target === f.wrap[0] || h.contains(f.wrap[0], t.target) ? void 0 : (f._setFocus(),
            !1)
        },
    ...
    h.fn.magnificPopup = function(t) {
        ...
        f._openClick({
            mfpEl: s
        }, o, e)) : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1)) : (t = h.extend(!0, {}, t),
        ...
        proto: {
            ...
            getInline: function(t, e) {
                ...
                t.src) {
                    ...
                    return o.length ? ((i = o[0].parentNode) && i.tagName && (k || (T = s.hiddenClass,
                    k = c(T),
                    T = "mfp-" + T),
                    S = o.after(k).detach().removeClass(T)),
                    f.updateStatus("ready")) : (f.updateStatus("error", s.tNotFound),
                    o = h("<div>")),
                    t.inlineElement = o
                }
    ...
    function $() {
        M && h(document.body).removeClass(M)
    }
    function z() {
        $(),
        f.req && f.req.abort()
                ...
                var i = 0
                  ...
                  , o = function(t) {
                    ...
                    I = setInterval(function() {
                        return 0 < s.naturalWidth ? void f._onImageHasSize(e) : (200 < i && clearInterval(I),
    ...
    h.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                ...
                r.enabled && f.supportsTransition && (s = r.duration,
                o = function(t) {
            ...
            _getOffset: function(t) {
                ...
                O ? s["-moz-transform"] = s.transform = "translate(" + i.left + "px," + i.top + "px)" : (s.left = i.left,
                s.top = i.top),
                s
            }
        }
    ...
    function A(t) {
        var e;
        !f.currTemplate[P] || (e = f.currTemplate[P].find("iframe")).length && (t || (e[0].src = "//about:blank"),
        ...
        proto: {
            initGallery: function() {
                ...
                d("BuildControls" + t, function() {
                    ...
                    t = f.arrowLeft = h(e.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(r),
                    e = f.arrowRight = h(e.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(r),
                    t.click(function() {
                        f.prev()
                    }),
                    e.click(function() {
...
function(t) {
    ...
    function v(t, n) {
        ...
        this.format = $.parseFormat(n.format || this.element.data("date-format") || D[this.language].format || $.getDefaultFormat(this.formatType, "input"), this.formatType),
        this.isInline = !1,
        this.isVisible = !1,
        this.isInput = this.element.is("input"),
        this.fontAwesome = n.fontAwesome || this.element.data("font-awesome") || !1,
        this.bootcssVer = n.bootcssVer || (this.isInput ? this.element.is(".form-control") ? 3 : 2 : this.bootcssVer = this.element.is(".input-group") ? 3 : 2),
        this.component = !!this.element.is(".date") && (3 === this.bootcssVer ? this.element.find(".input-group-addon .glyphicon-th, .input-group-addon .fa-times, .input-group-addon .fa-times, .input-group-addon .fa-calendar-alt, .input-group-addon .fa-calendar-alt, .input-group-addon .fa-times") : this.element.find(".add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar, .add-on .fa-calendar-alt, .add-on .fa-times")).parent(),
        this.componentReset = !!this.element.is(".date") && (3 === this.bootcssVer ? this.element.find(".input-group-addon .fa-times, .input-group-addon .fa-times") : this.element.find(".add-on .icon-remove, .add-on .fa-times")).parent(),
        this.hasInput = this.component && this.element.find("input").length,
        this.component && 0 === this.component.length && (this.component = !1),
        this.linkField = n.linkField || this.element.data("link-field") || !1,
        this.linkFormat = $.parseFormat(n.linkFormat || this.element.data("link-format") || $.getDefaultFormat(this.formatType, "link"), this.formatType),
        ...
        this.zIndex = n.zIndex || this.element.data("z-index") || r,
        this.title = void 0 !== n.title && n.title,
        this.timezone = n.timezone || function() {
            var t, e, i, s = (new Date).toString(), o = (null != (i = s.split("(")[1]) ? i.slice(0, -1) : 0) || s.split(" ");
            if (o instanceof Array) {
                e = [];
                for (var n = 0, r = o.length; n < r; n++)
                    (t = null !== (i = o[n].match(/\b[A-Z]+\b/))) && i[0] && e.push(t);
                o = e.pop()
            }
            return o
        }(),
        this.icons = {
            leftArrow: this.fontAwesome || 3 === this.bootcssVer ? "fa-arrow-left" : "icon-arrow-left",
            rightArrow: this.fontAwesome ? "fas fa-arrow-right" : 3 === this.bootcssVer ? "fa-arrow-right" : "icon-arrow-right"
        },
        this.icontype = this.fontAwesome ? "fa" : "fas",
        this._attachEvents(),
        this.clickedOutside = function(t) {
            0 === T(t.target).closest(".datetimepicker").length && e.hide()
        }
        ,
        ...
        this.minView = $.convertViewMode(this.minView),
        this.maxView = $.modes.length - 1,
        "maxView"in n ? this.maxView = n.maxView : "maxView"in this.element.data() && (this.maxView = this.element.data("max-view")),
        this.maxView = $.convertViewMode(this.maxView),
        ...
        this.startViewMode = $.convertViewMode(this.startViewMode),
        ...
        this.viewSelect = $.convertViewMode(this.viewSelect),
        this.forceParse = !0,
        ...
        for (var i = 3 === this.bootcssVer ? $.templateV3 : $.template; -1 !== i.indexOf("{iconType}"); )
        ...
        this.picker = T(i).appendTo(this.isInline ? this.element : this.container).on({
        ...
        this.clearBtn = n.clearBtn || this.element.data("date-clear-btn") || !1,
        this.todayHighlight = n.todayHighlight || this.element.data("date-today-highlight") || !1,
        void (this.weekStart = 0) !== n.weekStart ? this.weekStart = n.weekStart : void 0 !== this.element.data("date-weekstart") ? this.weekStart = this.element.data("date-weekstart") : void 0 !== D[this.language].weekStart && (this.weekStart = D[this.language].weekStart),
        this.weekStart = this.weekStart % 7,
        this.weekEnd = (this.weekStart + 6) % 7,
        this.onRenderDay = function(t) {
            t = (n.onRenderDay || function() {
                return []
            }
            )(t);
            "string" == typeof t && (t = [t]);
        ...
        this.onRenderMinute = function(t) {
            ...
            t < this.startDate || t > this.endDate ? i.push("disabled") : Math.floor(this.date.getUTCMinutes() / this.minuteStep) === Math.floor(t.getUTCMinutes() / this.minuteStep) && i.push("active"),
            i.concat(e || [])
        }
        ,
        this.onRenderYear = function(t) {
            var e = (n.onRenderYear || function() {
              ...
              , i = ["year"];
            "string" == typeof e && (e = [e]),
            this.date.getUTCFullYear() === t.getUTCFullYear() && i.push("active");
            var s = t.getUTCFullYear()
              , o = this.endDate.getUTCFullYear();
            return (t < this.startDate || o < s) && i.push("disabled"),
            i.concat(e || [])
        }
        ,
        this.onRenderMonth = function(t) {
            t = (n.onRenderMonth || function() {
                return []
            }
            )(t);
            return "string" == typeof t && (t = [t]),
        ...
        this.setDatesDisabled(n.datesDisabled || this.element.data("date-dates-disabled")),
        this.setDaysOfWeekDisabled(n.daysOfWeekDisabled || this.element.data("date-days-of-week-disabled")),
        this.setMinutesDisabled(n.minutesDisabled || this.element.data("date-minute-disabled")),
        this.setHoursDisabled(n.hoursDisabled || this.element.data("date-hour-disabled")),
        this.fillDow(),
        this.fillMonths(),
        this.update(),
        this.showMode(),
    ...
    v.prototype = {
        ...
        setFormat: function(t) {
            var e;
            this.format = $.parseFormat(t, this.formatType),
        ...
        getFormattedDate: function(t) {
            ...
            $.formatDate(this.date, t, this.language, this.formatType, this.timezone)
        },
        setStartDate: function(t) {
            this.startDate = t || this.startDate,
            8639968443048e3 !== this.startDate.valueOf() && (this.startDate = $.parseDate(this.startDate, this.format, this.language, this.formatType, this.timezone)),
            this.update(),
            this.updateNavArrows()
        },
        setEndDate: function(t) {
            this.endDate = t || this.endDate,
            8639968443048e3 !== this.endDate.valueOf() && (this.endDate = $.parseDate(this.endDate, this.format, this.language, this.formatType, this.timezone)),
            this.update(),
            this.updateNavArrows()
        },
        setDatesDisabled: function(t) {
            this.datesDisabled = t || [],
            T.isArray(this.datesDisabled) || (this.datesDisabled = this.datesDisabled.split(/,\s*/));
            var e = this;
            this.datesDisabled = T.map(this.datesDisabled, function(t) {
                return $.parseDate(t, e.format, e.language, e.formatType, e.timezone).toDateString()
            }),
            this.update(),
            this.updateNavArrows()
        },
        ...
        setMinutesDisabled: function(t) {
            ...
            T.isArray(this.minutesDisabled) || (this.minutesDisabled = this.minutesDisabled.split(/,\s*/)),
            this.minutesDisabled = T.map(this.minutesDisabled, function(t) {
                return parseInt(t, 10)
            }),
            this.update(),
            this.updateNavArrows()
        ...
        setHoursDisabled: function(t) {
            ...
            T.isArray(this.hoursDisabled) || (this.hoursDisabled = this.hoursDisabled.split(/,\s*/)),
            this.hoursDisabled = T.map(this.hoursDisabled, function(t) {
                return parseInt(t, 10)
            }),
            this.update(),
            this.updateNavArrows()
        ...
        place: function() {
            ...
            this.zIndex = e + 10),
            s = (this.container instanceof T ? this.container : T(this.container)).offset(),
            ...
            (o = document.body.clientWidth || window.innerWidth) < i + 220 && (i = o - 220),
            t = "top-left" === this.pickerPosition || "top-right" === this.pickerPosition ? t.top - this.picker.outerHeight() : t.top + this.height,
            t -= s.top,
            i -= s.left,
            this.picker.css({
                top: t,
        ...
        update: function() {
            ...
            e = !0) : "string" == typeof (t = (this.isInput ? this.element : this.element.find("input")).val() || this.element.data("date") || this.initialDate) && (t = t.replace(/^\s+|\s+$/g, "")),
            t || (t = new Date,
            e = !1),
            "string" == typeof t && (new RegExp(this.hour_minute).test(t) || new RegExp(this.hour_minute + ":[0-5][0-9]").test(t)) && (t = this.getDate()),
            this.date = $.parseDate(t, this.format, this.language, this.formatType, this.timezone),
            e && this.setValue(),
        ...
        fillDow: function() {
            for (var t = this.weekStart, e = "<tr>"; t < this.weekStart + 7; )
                e += '<th class="dow">' + D[this.language].daysMin[t++ % 7] + "</th>";
            e += "</tr>",
        ...
        fillMonths: function() {
            for (var t = "", e = new Date(this.viewDate), i = 0; i < 12; i++)
                e.setUTCMonth(i),
                t += '<span class="' + this.onRenderMonth(e).join(" ") + '">' + D[this.language].monthsShort[i] + "</span>";
        ...
        fill: function() {
            if (this.date && this.viewDate) {
                var t = (w = new Date(this.viewDate)).getUTCFullYear()
                  ...
                  , a = this.endDate.getUTCMonth() + 1
                  , l = new k(this.date.getUTCFullYear(),this.date.getUTCMonth(),this.date.getUTCDate()).valueOf()
                  , h = new Date;
                this.setTitle(".datetimepicker-days", D[this.language].months[e] + " " + t),
                "time" === this.formatViewType ? (C = this.getFormattedDate(),
                this.setTitle(".datetimepicker-hours", C),
                this.setTitle(".datetimepicker-minutes", C)) : (this.setTitle(".datetimepicker-hours", i + " " + D[this.language].months[e] + " " + t),
                this.setTitle(".datetimepicker-minutes", i + " " + D[this.language].months[e] + " " + t)),
                this.picker.find("tfoot th.today").text(D[this.language].today || D.en.today).toggle(!1 !== this.todayBtn),
                this.picker.find("tfoot th.clear").text(D[this.language].clear || D.en.clear).toggle(!1 !== this.clearBtn),
                this.updateNavArrows(),
                this.fillMonths();
                var d = k(t, e - 1, 28, 0, 0, 0, 0)
                  , c = $.getDaysInMonth(d.getUTCFullYear(), d.getUTCMonth());
                d.setUTCDate(c),
                d.setUTCDate(c - (d.getUTCDay() - this.weekStart + 7) % 7);
                var u = new Date(d);
                u.setUTCDate(u.getUTCDate() + 42),
                u = u.valueOf();
                for (var p, f = []; d.valueOf() < u; )
                    d.getUTCDay() === this.weekStart && f.push("<tr>"),
                    p = this.onRenderDay(d),
                    d.getUTCFullYear() < t || d.getUTCFullYear() === t && d.getUTCMonth() < e ? p.push("old") : (d.getUTCFullYear() > t || d.getUTCFullYear() === t && d.getUTCMonth() > e) && p.push("new"),
                    this.todayHighlight && d.getUTCFullYear() === h.getFullYear() && d.getUTCMonth() === h.getMonth() && d.getUTCDate() === h.getDate() && p.push("today"),
                    d.valueOf() === l && p.push("active"),
                    (d.valueOf() + 864e5 <= this.startDate || d.valueOf() > this.endDate || -1 !== T.inArray(d.getUTCDay(), this.daysOfWeekDisabled) || -1 !== T.inArray(d.toDateString(), this.datesDisabled)) && p.push("disabled"),
                    f.push('<td class="' + p.join(" ") + '">' + d.getUTCDate() + "</td>"),
                    d.getUTCDay() === this.weekEnd && f.push("</tr>"),
                    d.setUTCDate(d.getUTCDate() + 1);
                this.picker.find(".datetimepicker-days tbody").empty().append(f.join("")),
                f = [];
                for (var g = "", m = "", y = "", v = this.hoursDisabled || [], w = new Date(this.viewDate), b = 0; b < 24; b++) {
                    w.setUTCHours(b),
                    p = this.onRenderHour(w),
                    -1 !== v.indexOf(b) && p.push("disabled");
                    var _ = k(t, e, i, b);
                    _.valueOf() + 36e5 <= this.startDate || _.valueOf() > this.endDate ? p.push("disabled") : s === b && p.push("active"),
                    this.showMeridian && 2 === D[this.language].meridiem.length ? ((m = b < 12 ? D[this.language].meridiem[0] : D[this.language].meridiem[1]) !== y && ("" !== y && f.push("</fieldset>"),
                    f.push('<fieldset class="hour"><legend>' + m.toUpperCase() + "</legend>")),
                    y = m,
                    g = b % 12 || 12,
                    b < 12 ? p.push("hour_am") : p.push("hour_pm"),
                    f.push('<span class="' + p.join(" ") + '">' + g + "</span>"),
                    23 === b && f.push("</fieldset>")) : (g = b + ":00",
                    f.push('<span class="' + p.join(" ") + '">' + g + "</span>"))
                }
                ...
                for (b = 0; b < 60; b += this.minuteStep)
                    -1 === x.indexOf(b) && (w.setUTCMinutes(b),
                    w.setUTCSeconds(0),
                    p = this.onRenderMinute(w),
                    this.showMeridian && 2 === D[this.language].meridiem.length ? ((m = s < 12 ? D[this.language].meridiem[0] : D[this.language].meridiem[1]) !== y && ("" !== y && f.push("</fieldset>"),
                    f.push('<fieldset class="minute"><legend>' + m.toUpperCase() + "</legend>")),
                    y = m,
                    g = s % 12 || 12,
                    f.push('<span class="' + p.join(" ") + '">' + g + ":" + (b < 10 ? "0" + b : b) + "</span>"),
                    59 === b && f.push("</fieldset>")) : (g = b + ":00",
                    f.push('<span class="' + p.join(" ") + '">' + s + ":" + (b < 10 ? "0" + b : b) + "</span>")));
                this.picker.find(".datetimepicker-minutes td").html(f.join(""));
                var C = this.date.getUTCFullYear()
                  , c = this.setTitle(".datetimepicker-months", t).end().find(".month").removeClass("active");
                C === t && c.eq(this.date.getUTCMonth()).addClass("active"),
                (t < o || r < t) && c.addClass("disabled"),
                t === o && c.slice(0, n).addClass("disabled"),
                t === r && c.slice(a).addClass("disabled"),
                f = "",
                t = 10 * parseInt(t / 10, 10);
                a = this.setTitle(".datetimepicker-years", t + "-" + (t + 9)).end().find("td");
                --t,
                w = new Date(this.viewDate);
                for (b = -1; b < 11; b++)
                    w.setUTCFullYear(t),
        ...
        updateNavArrows: function() {
            ...
            case 0:
                e <= this.startDate.getUTCFullYear() && i <= this.startDate.getUTCMonth() && s <= this.startDate.getUTCDate() && o <= this.startDate.getUTCHours() ? this.picker.find(".prev").css({
                    visibility: "hidden"
                }) : this.picker.find(".prev").css({
                    visibility: "visible"
                }),
                e >= this.endDate.getUTCFullYear() && i >= this.endDate.getUTCMonth() && s >= this.endDate.getUTCDate() && o >= this.endDate.getUTCHours() ? this.picker.find(".next").css({
                    visibility: "hidden"
        ...
        click: function(t) {
            t.stopPropagation(),
            t.preventDefault();
            var e, i, s, o, n, r, a = T(t.target).closest("span, td, th, legend");
            if (a.is("." + this.icontype) && (a = T(a).parent().closest("span, td, th, legend")),
            1 === a.length)
                if (a.is(".disabled"))
                    this.element.trigger({
                        type: "outOfRange",
                    ...
                    case "th":
                        ...
                        case "prev":
                        case "next":
                            var l = $.modes[this.viewMode].navStep * ("prev" === a[0].className ? -1 : 1);
                            switch (this.viewMode) {
                            case 0:
                                this.viewDate = this.moveHour(this.viewDate, l);
                                break;
                            case 1:
                                this.viewDate = this.moveDate(this.viewDate, l);
                                break;
                            case 2:
                        ...
                        case "today":
                            var h = new Date;
                            (h = k(h.getFullYear(), h.getMonth(), h.getDate(), h.getHours(), h.getMinutes(), h.getSeconds(), 0)) < this.startDate ? h = this.startDate : h > this.endDate && (h = this.endDate),
                            this.viewMode = this.startViewMode,
                            this.showMode(0),
                            this._setDate(h),
                            this.fill(),
                    ...
                    case "span":
                        ...
                        3 <= this.viewSelect && this._setDate(k(i, s, e, o, n, r, 0))) : a.is(".year") ? (this.viewDate.setUTCDate(1),
                        ...
                        4 <= this.viewSelect && this._setDate(k(i, s, e, o, n, r, 0))) : a.is(".hour") ? (o = parseInt(a.text(), 10) || 0,
                        (a.hasClass("hour_am") || a.hasClass("hour_pm")) && (12 === o && a.hasClass("hour_am") ? o = 0 : 12 !== o && a.hasClass("hour_pm") && (o += 12)),
                        this.viewDate.setUTCHours(o),
                        this.element.trigger({
                            type: "changeHour",
                            date: this.viewDate
                        }),
                        1 <= this.viewSelect && this._setDate(k(i, s, e, o, n, r, 0))) : a.is(".minute") && (n = parseInt(a.text().substr(a.text().indexOf(":") + 1), 10) || 0,
                        this.viewDate.setUTCMinutes(n),
                        this.element.trigger({
                            type: "changeMinute",
                            date: this.viewDate
                        }),
                        0 <= this.viewSelect && this._setDate(k(i, s, e, o, n, r, 0))),
                        ...
                        break;
                    case "td":
                        a.is(".day") && !a.is(".disabled") && (e = parseInt(a.text(), 10) || 1,
                        ...
                        2 <= this.viewSelect && this._setDate(k(i, s, e, o, n, r, 0)));
                        var d = this.viewMode;
                        this.showMode(-1),
                        this.fill(),
        ...
        moveMonth: function(t, e) {
            if (!e)
                return t;
            var i, s, o = new Date(t.valueOf()), n = o.getUTCDate(), r = o.getUTCMonth(), a = Math.abs(e);
            if (e = 0 < e ? 1 : -1,
            1 === a)
                s = -1 === e ? function() {
        ...
        keydown: function(t) {
            if (this.picker.is(":not(:visible)"))
                ...
                case 39:
                    ...
                    e = 37 === t.keyCode ? -1 : 1;
                    var r = this.viewMode;
                    t.ctrlKey ? r += 2 : t.shiftKey && (r += 1),
                    4 === r ? (i = this.moveYear(this.date, e),
                    s = this.moveYear(this.viewDate, e)) : 3 === r ? (i = this.moveMonth(this.date, e),
                    s = this.moveMonth(this.viewDate, e)) : 2 === r ? (i = this.moveDate(this.date, e),
                    s = this.moveDate(this.viewDate, e)) : 1 === r ? (i = this.moveHour(this.date, e),
                    s = this.moveHour(this.viewDate, e)) : 0 === r && (i = this.moveMinute(this.date, e),
                ...
                case 40:
                    ...
                    4 === r ? (i = this.moveYear(this.date, e),
                    s = this.moveYear(this.viewDate, e)) : 3 === r ? (i = this.moveMonth(this.date, e),
                    s = this.moveMonth(this.viewDate, e)) : 2 === r ? (i = this.moveDate(this.date, 7 * e),
                    s = this.moveDate(this.viewDate, 7 * e)) : 1 === r ? s = this.showMeridian ? (i = this.moveHour(this.date, 6 * e),
                    this.moveHour(this.viewDate, 6 * e)) : (i = this.moveHour(this.date, 4 * e),
                    this.moveHour(this.viewDate, 4 * e)) : 0 === r && (i = this.moveMinute(this.date, 4 * e),
                    s = this.moveMinute(this.viewDate, 4 * e)),
                    this.dateWithinRange(i) && (this.date = i,
                    this.viewDate = s,
                    this.setValue(),
                    this.update(),
                ...
                n && (this.isInput ? o = this.element : this.component && (o = this.element.find("input")),
                o && o.change(),
                this.element.trigger({
                    type: "changeDate",
                    date: this.getDate()
        ...
        showMode: function(t) {
            !t || (t = Math.max(0, Math.min($.modes.length - 1, this.viewMode + t))) >= this.minView && t <= this.maxView && (this.element.trigger({
                type: "changeMode",
                date: this.viewDate,
            ...
            this.viewMode = t),
            this.picker.find(">div").hide().filter(".datetimepicker-" + $.modes[this.viewMode].clsName).css("display", "block"),
            this.updateNavArrows()
        },
        reset: function() {
    ...
    T.fn.datetimepicker = function(s) {
        var o, n = Array.apply(null, arguments);
        return n.shift(),
        this.each(function() {
            var t = T(this)
              , e = t.data("datetimepicker")
              , i = "object" == typeof s && s;
            if (e || t.data("datetimepicker", e = new v(this,T.extend({}, T.fn.datetimepicker.defaults, i))),
            "string" == typeof s && "function" == typeof e[s] && (o = e[s].apply(e, n)) !== r)
                return !1
        }),
        o !== r ? o : this
    }
    ...
    T.fn.datetimepicker.Constructor = v;
    var D = T.fn.datetimepicker.dates = {
        en: {
      ...
      , $ = {
        ...
        getDaysInMonth: function(t, e) {
            return [31, $.isLeapYear(t) ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][e]
        },
        ...
        parseDate: function(t, e, i, s, o) {
            ...
            /^[-+]\d+[dmwy]([\s,]+[-+]\d+[dmwy])*$/.test(t)) {
                var r, a = /([-+]\d+)([dmwy])/, l = t.match(/([-+]\d+)([dmwy])/g);
                t = new Date;
                for (var h = 0; h < l.length; h++)
                    ...
                    case "d":
                        ...
                        break;
                    case "m":
                        t = v.prototype.moveMonth.call(v.prototype, t, r);
                        break;
                    case "w":
                        t.setUTCDate(t.getUTCDate() + 7 * r);
                        break;
                    case "y":
                        t = v.prototype.moveYear.call(v.prototype, t, r)
                    }
                return k(t.getUTCFullYear(), t.getUTCMonth(), t.getUTCDate(), t.getUTCHours(), t.getUTCMinutes(), t.getUTCSeconds(), 0)
            }
            var d, c, u, l = t && t.toString().match(this.nonpunctuation) || [], t = new Date(0,0,0,0,0,0,0), p = {}, f = ["hh", "h", "ii", "i", "ss", "s", "yyyy", "yy", "M", "MM", "m", "mm", "D", "DD", "d", "dd", "H", "HH", "p", "P", "z", "Z"], g = {
                hh: function(t, e) {
            ...
            if (g.M = g.MM = g.mm = g.m,
            g.dd = g.d,
            g.P = g.p,
            g.Z = g.z,
            t = k(t.getFullYear(), t.getMonth(), t.getDate(), t.getHours(), t.getMinutes(), t.getSeconds()),
            l.length === e.parts.length) {
                for (var h = 0, m = e.parts.length; h < m; h++) {
                    if (d = parseInt(l[h], 10),
                    u = e.parts[h],
                    isNaN(d))
                        switch (u) {
                        case "MM":
                            c = T(D[i].months).filter(function() {
                                var t = this.slice(0, l[h].length);
                                return t === l[h].slice(0, t.length)
                            }),
                            d = T.inArray(c[0], D[i].months) + 1;
                            break;
                        case "M":
                            c = T(D[i].monthsShort).filter(function() {
                                var t = this.slice(0, l[h].length)
                                  , e = l[h].slice(0, t.length);
                                return t.toLowerCase() === e.toLowerCase()
                            }),
                            d = T.inArray(c[0], D[i].monthsShort) + 1;
                            break;
                        case "p":
                        case "P":
                            d = T.inArray(l[h].toLowerCase(), D[i].meridiem)
                        }
                    p[u] = d
                }
                for (var y, h = 0; h < f.length; h++)
                    (y = f[h])in p && !isNaN(p[y]) && g[y](t, p[y])
            }
            return t
        },
        formatDate: function(t, e, i, s, o) {
            ...
            if ("standard" === s)
                n = {
                    ...
                    m: t.getUTCMonth() + 1,
                    M: D[i].monthsShort[t.getUTCMonth()],
                    MM: D[i].months[t.getUTCMonth()],
                    d: t.getUTCDate(),
                    D: D[i].daysShort[t.getUTCDay()],
                    DD: D[i].days[t.getUTCDay()],
                    p: 2 === D[i].meridiem.length ? D[i].meridiem[t.getUTCHours() < 12 ? 0 : 1] : "",
                    h: t.getUTCHours(),
                    i: t.getUTCMinutes(),
                    s: t.getUTCSeconds(),
                    z: o
                },
                2 === D[i].meridiem.length ? n.H = n.h % 12 == 0 ? 12 : n.h % 12 : n.H = n.h,
                n.HH = (n.H < 10 ? "0" : "") + n.H,
                n.P = n.p.toUpperCase(),
                n.Z = n.z,
                n.hh = (n.h < 10 ? "0" : "") + n.h,
                ...
                (n = {
                    ...
                    Y: t.getUTCFullYear(),
                    F: D[i].months[t.getUTCMonth()],
                    M: D[i].monthsShort[t.getUTCMonth()],
                    n: t.getUTCMonth() + 1,
                    t: $.getDaysInMonth(t.getUTCFullYear(), t.getUTCMonth()),
                    j: t.getUTCDate(),
                    l: D[i].days[t.getUTCDay()],
                    D: D[i].daysShort[t.getUTCDay()],
                    w: t.getUTCDay(),
                    N: 0 === t.getUTCDay() ? 7 : t.getUTCDay(),
                    S: t.getUTCDate() % 10 <= D[i].suffix.length ? D[i].suffix[t.getUTCDate() % 10 - 1] : "",
                    a: 2 === D[i].meridiem.length ? D[i].meridiem[t.getUTCHours() < 12 ? 0 : 1] : "",
            ...
            for (var t = [], r = T.extend([], e.separators), a = 0, l = e.parts.length; a < l; a++)
...
function(t, e) {
    ...
    !function() {
        ...
        e.prototype.addHtml = function(t) {
            ...
            e || (null != o ? "." !== (s = o.substring(0, 1)) && "#" !== s || (o = (this.s.subHtmlSelectorRelative && !this.s.dynamic ? i.find(o) : f(o)).html()) : o = ""),
        ...
        e.prototype.loadContent = function(e, t, i) {
            var s, a, o, n, r, l, h = this, d = !1, c = function(t) {
            ...
            }, u = h.s.dynamic ? (h.s.dynamicEl[e].poster && (d = !0,
            o = h.s.dynamicEl[e].poster),
            r = h.s.dynamicEl[e].html,
            a = h.s.dynamicEl[e].src,
            l = h.s.dynamicEl[e].alt,
            h.s.dynamicEl[e].responsive && c(h.s.dynamicEl[e].responsive.split(",")),
            n = h.s.dynamicEl[e].srcset,
            h.s.dynamicEl[e].sizes) : ((p = h.$items.eq(e)).attr("data-poster") && (d = !0,
            o = p.attr("data-poster")),
            r = p.attr("data-html"),
            a = p.attr("href") || p.attr("data-src"),
            l = p.attr("title") || p.find("img").first().attr("alt"),
            p.attr("data-responsive") && c(p.attr("data-responsive").split(",")),
            n = p.attr("data-srcset"),
            p.attr("data-sizes")), c = !1;
            h.s.dynamic ? h.s.dynamicEl[e].iframe && (c = !0) : "true" === h.$items.eq(e).attr("data-iframe") && (c = !0);
            var p = h.isVideo(a, e);
            if (!h.$slide.eq(e).hasClass("lg-loaded")) {
                if (c ? h.$slide.eq(e).prepend('<div class="lg-video-cont lg-has-iframe" style="max-width:' + h.s.iframeMaxWidth + '"><div class="lg-video"><iframe class="lg-object" frameborder="0" src="' + a + '"  allowfullscreen="true"></iframe></div></div>') : d ? (c = "",
                c = p && p.youtube ? "lg-has-youtube" : p && p.vimeo ? "lg-has-vimeo" : "lg-has-html5",
                h.$slide.eq(e).prepend('<div class="lg-video-cont ' + c + ' "><div class="lg-video"><span class="lg-video-play"></span><img class="lg-object lg-has-poster" src="' + o + '" /></div></div>')) : p ? (h.$slide.eq(e).prepend('<div class="lg-video-cont "><div class="lg-video"></div></div>'),
                h.$el.trigger("hasVideo.lg", [e, a, r])) : (l = l ? 'alt="' + l + '"' : "",
                h.$slide.eq(e).prepend('<div class="lg-img-wrap"><img class="lg-object lg-image" ' + l + ' src="' + a + '" /></div>')),
            ...
            h.$slide.eq(e).find(".lg-object").on("load.lg error.lg", function() {
                var t = 0;
                i && !f("body").hasClass("lg-from-hash") && (t = i),
                setTimeout(function() {
                    h.$slide.eq(e).addClass("lg-complete"),
                    h.$el.trigger("onSlideItemLoad.lg", [e, i || 0])
                }, t)
            }),
            p && p.html5 && !d && h.$slide.eq(e).addClass("lg-complete"),
            !0 === t && (h.$slide.eq(e).hasClass("lg-complete") ? h.preload(e) : h.$slide.eq(e).find(".lg-object").on("load.lg error.lg", function() {
                h.preload(e)
            }))
        }
        ,
        e.prototype.slide = function(t, e, i, s) {
            var o, n, r, a, l, h = this.$outer.find(".lg-current").index(), d = this;
            d.lGalleryOn && h === t || (o = this.$slide.length,
            n = d.lGalleryOn ? this.s.speed : 0,
            d.lgBusy || (this.s.download && ((r = d.s.dynamic ? !1 !== d.s.dynamicEl[t].downloadUrl && (d.s.dynamicEl[t].downloadUrl || d.s.dynamicEl[t].src) : "false" !== d.$items.eq(t).attr("data-download-url") && (d.$items.eq(t).attr("data-download-url") || d.$items.eq(t).attr("href") || d.$items.eq(t).attr("data-src"))) ? (f("#lg-download").attr("href", r),
            d.$outer.removeClass("lg-hide-download")) : d.$outer.addClass("lg-hide-download")),
            ...
            2 < o ? (a = t - 1,
            l = t + 1,
            (0 === t && h === o - 1 || t === o - 1 && 0 === h) && (l = 0,
            a = o - 1)) : (a = 0,
            l = 1),
            "prev" === s ? d.$slide.eq(l).addClass("lg-next-slide") : d.$slide.eq(a).addClass("lg-prev-slide"),
            d.$slide.eq(t).addClass("lg-current")) : (d.$outer.addClass("lg-no-trans"),
            this.$slide.removeClass("lg-prev-slide lg-next-slide"),
            "prev" === s ? (this.$slide.eq(t).addClass("lg-prev-slide"),
            this.$slide.eq(h).addClass("lg-next-slide")) : (this.$slide.eq(t).addClass("lg-next-slide"),
            ...
            setTimeout(function() {
                d.lgBusy = !1,
                d.$el.trigger("onAfterSlide.lg", [h, t, e, i])
            }, this.s.speed)) : (d.loadContent(t, !0, d.s.backdropDuration),
            d.lgBusy = !1,
            d.$el.trigger("onAfterSlide.lg", [h, t, e, i])),
            d.lGalleryOn = !0,
...
function(t, e) {
    ...
    !function() {
        "use strict";
        function t(t) {
            return this.core = h(t).data("lightGallery"),
            this.$el = h(t),
            ...
            s.core.$el.on("onBeforeSlide.lg.tm", function(t, e, i) {
                ...
                if (n)
                    ...
                    if (s.core.s.videojs)
                        ...
                        l.pause();
                e && h(e).attr("src", h(e).attr("src").replace("&autoplay", "&noplay"));
        ...
        t.prototype.loadVideo = function(t, e, i, s, o) {
            ...
            this.core.s.youtubePlayerParams && (l = l + "&" + h.param(this.core.s.youtubePlayerParams)),
            ...
            this.core.s.vimeoPlayerParams && (l = l + "&" + h.param(this.core.s.vimeoPlayerParams)),
            ...
            this.core.s.dailymotionPlayerParams && (l = l + "&" + h.param(this.core.s.dailymotionPlayerParams)),
            r = '<iframe class="lg-video-object lg-dailymotion ' + e + '" ' + n + ' width="560" height="315" src="//www.dailymotion.com/embed/video/' + s.dailymotion[1] + l + '" frameborder="0" allowfullscreen></iframe>') : s.html5 ? ("." !== (i = o.substring(0, 1)) && "#" !== i || (o = h(o).html()),
            r = o) : s.vk && (l = "&autoplay=" + a,
            this.core.s.vkPlayerParams && (l = l + "&" + h.param(this.core.s.vkPlayerParams)),
...
function(t, e) {
    ...
    !function() {
        ...
        t.prototype.zoomSwipe = function() {
            var s, o = this, n = {}, r = {}, a = !1, l = !1, h = !1, d = 0;
            ...
            o.core.$slide.on("touchmove.lg", function(t) {
                ...
                t = l ? -Math.abs(e.attr("data-x")) + (r.x - n.x) * o.getModifier(d, "X", s) : -Math.abs(e.attr("data-x")),
            ...
            o.core.$slide.on("touchend.lg", function() {
                ...
                o.touchendZoom(n, r, l, h, d))
            })
        }
        ,
        t.prototype.zoomDrag = function() {
            var s, o = this, n = {}, r = {}, a = !1, l = !1, h = !1, d = !1, c = 0;
            o.core.$slide.on("mousedown.lg.zoom", function(t) {
                ...
                d = e.allowY,
                h = e.allowX,
                o.core.$outer.hasClass("lg-zoomed") && u(t.target).hasClass("lg-object") && (h || d) && (t.preventDefault(),
            ...
            u(window).on("mousemove.lg.zoom", function(t) {
                ...
                l = !0,
                r = o.getDragCords(t, Math.abs(c)),
                o.core.$outer.addClass("lg-zoom-dragging"),
                i = d ? -Math.abs(e.attr("data-y")) + (r.y - n.y) * o.getModifier(c, "Y", s) : -Math.abs(e.attr("data-y")),
                t = h ? -Math.abs(e.attr("data-x")) + (r.x - n.x) * o.getModifier(c, "X", s) : -Math.abs(e.attr("data-x")),
            ...
            u(window).on("mouseup.lg.zoom", function(t) {
                a && (a = !1,
                o.core.$outer.removeClass("lg-zoom-dragging"),
                !l || n.x === r.x && n.y === r.y || (r = o.getDragCords(t, Math.abs(c)),
                o.touchendZoom(n, r, h, d, c)),
                l = !1),
        ...
        t.prototype.touchendZoom = function(t, e, i, s, o) {
            var n = this
              ...
              , h = -Math.abs(r.attr("data-x")) + (e.x - t.x) * n.getModifier(o, "X", l)
            ...
            i && (h <= -o.maxX ? h = -o.maxX : h >= -o.minX && (h = -o.minX)),
            s ? r.attr("data-y", Math.abs(l)) : l = -Math.abs(r.attr("data-y")),
            i ? r.attr("data-x", Math.abs(h)) : h = -Math.abs(r.attr("data-x")),
            n.core.s.useLeftForZoom ? r.css({
                left: h + "px",
                top: l + "px"
            }) : r.css("transform", "translate3d(" + h + "px, " + l + "px, 0)"))
        }
        ,
        t.prototype.destroy = function() {
            var t = this;
...
function(t) {
    ...
    function e(t) {
        var e, i = t || window.event, s = g.call(arguments, 1), o = 0, n = 0, r = 0, a = 0, l = 0, h = 0;
        ...
        0 === r && (o = -1 * n)),
        0 !== r || 0 !== n) {
            1 === i.deltaMode ? (o *= e = d.data(this, "mousewheel-line-height"),
            r *= e,
            n *= e) : 2 === i.deltaMode && (o *= e = d.data(this, "mousewheel-page-height"),
            r *= e,
            n *= e);
            var a = Math.max(Math.abs(r), Math.abs(n));
            return f && !(a < f) || u(i, f = a) && (f /= 40),
            u(i, a) && (o /= 40,
            n /= 40,
            r /= 40),
    ...
    var p, f, t = ["wheel", "mousewheel", "DOMMouseScroll", "MozMousePixelScroll"], i = "onwheel"in document || 9 <= document.documentMode ? ["wheel"] : ["mousewheel", "DomMouseScroll", "MozMousePixelScroll"], g = Array.prototype.slice;
    if (d.event.fixHooks)
    ...
    function i(l, h, d) {
        ...
        d.fn[l] = function(t) {
            if ("string" != typeof t)
                ...
                this;
            var s, o, n, r, a, e = c.call(arguments, 1);
            return o = e,
            r = "$()." + l + '("' + (s = t) + '")',
            (t = this).each(function(t, e) {
                var i = d.data(e, l);
                i ? (e = i[s]) && "_" != s.charAt(0) ? (i = e.apply(i, o),
                n = void 0 === n ? i : n) : u(r + " is not a valid method") : u(l + " not initialized. Cannot call methods, i.e. " + r)
            }),
            void 0 !== n ? n : t
        }
        ,
...
function(t, e) {
    ...
    function g(t) {
        ...
        d = f(u),
        g.isBoxSizeOuter = m = 200 == p(d.width),
        c.removeChild(u)),
        ...
        t && "object" == typeof t && t.nodeType) {
            ...
            var a = i.paddingLeft + i.paddingRight
              ...
              , t = s && m
              , s = p(e.width);
            !1 !== s && (i.width = s + (t ? 0 : a + c));
            s = p(e.height);
            return !1 !== s && (i.height = s + (t ? 0 : l + u)),
    ...
    var m, e = "undefined" == typeof console ? function() {}
    : function(t) {
        console.error(t)
    }
    , y = ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom", "marginLeft", "marginRight", "marginTop", "marginBottom", "borderLeftWidth", "borderRightWidth", "borderTopWidth", "borderBottomWidth"], v = y.length, w = !1;
    return g
}),
function(t, e) {
    "use strict";
...
function(t, e) {
    ...
    t.layoutPosition = function() {
        ...
        e[n] = this.getXValue(o),
        e[i] = "";
        o = s ? "paddingTop" : "paddingBottom",
        i = s ? "top" : "bottom",
        s = s ? "bottom" : "top",
    ...
    t._transitionTo = function(t, e) {
        ...
        !n || this.isTransitioning ? (i = t - i,
        e -= s,
        (s = {}).transform = this.getTranslate(i, e),
        this.transition({
            to: s,
            onTransitionEnd: {
...
function(o, n) {
    ...
    u._positionItem = function(t, e, i, s, o) {
        s ? t.goTo(e, i) : (t.stagger(o * this.stagger),
        t.moveTo(e, i))
    }
    ,
    ...
    u.dispatchEvent = function(t, e, i) {
        ...
        this.emitEvent(t, s),
        h && (this.$element = this.$element || h(this.element),
        e ? ((e = h.Event(e)).type = t,
...
function(t, e) {
    ...
    t._getItemLayoutPosition = function(t) {
        ...
        for (var e = t.size.outerWidth % this.columnWidth, i = Math[e && e < 1 ? "round" : "ceil"](t.size.outerWidth / this.columnWidth), i = Math.min(i, this.cols), s = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](i, t), e = {
            ...
            y: s.y
        }, o = s.y + t.size.outerHeight, n = i + s.col, r = s.col; r < n; r++)
            this.colYs[r] = o;
        return e
    }
    ,
    ...
    t._manageStamp = function(t) {
        ...
        for (var n = (this._getOption("originTop") ? i.top : i.bottom) + e.outerHeight, r = s; r <= o; r++)
...
function(t, e) {
    ...
    "use strict";
    var i, t = t.create("masonry"), s = t.prototype, o = {
        _getElementOffset: !0,
        layout: !0,
        _getMeasurement: !0
    };
    for (i in e.prototype)
        o[i] || (s[i] = e.prototype[i]);
...
function(r, a) {
    ...
    o._filter = function(t) {
        for (var e = (e = this.options.filter) || "*", i = [], s = [], o = [], n = this._getFilterTest(e), r = 0; r < t.length; r++) {
            var a, l = t[r];
            l.isIgnored || ((a = n(l)) && i.push(l),
            a && l.isHidden ? s.push(l) : a || l.isHidden || o.push(l))
        }
        return {
            matches: i,
            needReveal: s,
    ...
    var d = function(t) {
        if ("string" != typeof t)
            return t;
        var e, i, s = l(t).split(" "), o = s[0], t = (t = o.match(/^\[(.+)\]$/)) && t[1], n = (i = o,
        (e = t) ? function(t) {
    ...
    o._sort = function() {
        var t, r, a;
        this.options.sortBy && (t = n.makeArray(this.options.sortBy),
        ...
        t = function(t, e) {
            for (var i = 0; i < r.length; i++) {
                var s = r[i]
                  ...
                  , n = e.sortData[s];
                if (n < o || o < n)
                    return (n < o ? 1 : -1) * ((void 0 !== a[s] ? a[s] : a) ? 1 : -1)
            }
            return 0
        }
        ,
...
function(t, e) {
    ...
    , function(t, e) {
        ...
        i.prototype = {
            ...
            emit: function(t) {
                for (var e = [].slice.call(arguments, 1), i = ((this.e || (this.e = {}))[t] || []).slice(), s = 0, o = i.length; s < o; s++)
  ...
  , Prism = function(l) {
    var h = /\blang(?:uage)?-([\w-]+)\b/i
      ...
      , z = {
        ...
        util: {
            encode: function(t) {
                return t instanceof M ? new M(t.type,z.util.encode(t.content),t.alias) : Array.isArray(t) ? t.map(z.util.encode) : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
            },
            type: function(t) {
        ...
        languages: {
            extend: function(t, e) {
                var i, s = z.util.clone(z.languages[t]);
                for (i in e)
                    s[i] = e[i];
                return s
            },
            insertBefore: function(i, t, e, s) {
                var o, n = (s = s || z.languages)[i], r = {};
                for (o in n)
            ...
            DFS: function t(e, i, s, o) {
                o = o || {};
                var n, r, a, l = z.util.objId;
                for (n in e)
                    e.hasOwnProperty(n) && (i.call(e, n, e[n], s || n),
                    r = e[n],
                    "Object" !== (a = z.util.type(r)) || o[l(r)] ? "Array" !== a || o[l(r)] || (o[l(r)] = !0,
                    t(r, i, n, o)) : (o[l(r)] = !0,
                    t(r, i, null, o)))
            }
        },
        ...
        highlightAllUnder: function(t, e, i) {
            ...
            for (var o, n = s.elements || t.querySelectorAll(s.selector), r = 0; o = n[r++]; )
                z.highlightElement(o, !0 === e, s.callback)
        },
        highlightElement: function(t, e, i) {
            for (var s, o = "none", n = t; n && !h.test(n.className); )
                n = n.parentNode;
            n && (o = (n.className.match(h) || [, "none"])[1].toLowerCase(),
            s = z.languages[o]),
            t.className = t.className.replace(h, "").replace(/\s+/g, " ") + " language-" + o,
            t.parentNode && (n = t.parentNode,
            /pre/i.test(n.nodeName) && (n.className = n.className.replace(h, "").replace(/\s+/g, " ") + " language-" + o));
            function r(t) {
                a.highlightedCode = t,
            ...
            a.code ? (z.hooks.run("before-highlight", a),
            a.grammar ? e && l.Worker ? ((e = new Worker(z.filename)).onmessage = function(t) {
                r(t.data)
            }
            ,
        ...
        highlight: function(t, e, i) {
            ...
            return z.hooks.run("before-tokenize", i),
            i.tokens = z.tokenize(i.code, i.grammar),
            z.hooks.run("after-tokenize", i),
            M.stringify(z.util.encode(i.tokens), i.language)
        },
        matchGrammar: function(t, e, i, s, o, n, r) {
            for (var a in i)
                if (i.hasOwnProperty(a) && i[a]) {
                    if (a == r)
                        return;
                    for (var l = i[a], l = "Array" === z.util.type(l) ? l : [l], h = 0; h < l.length; ++h) {
                        var d, c = l[h], u = c.inside, p = !!c.lookbehind, f = !!c.greedy, g = 0, m = c.alias;
                        f && !c.pattern.global && (d = c.pattern.toString().match(/[imuy]*$/)[0],
                        c.pattern = RegExp(c.pattern.source, d + "g")),
                        c = c.pattern || c;
                        for (var y = s, v = o; y < e.length; v += e[y].length,
                        ++y) {
                            var w = e[y];
                            ...
                            if (!(w instanceof M)) {
                                if (f && y != e.length - 1) {
                                    ...
                                    !(k = c.exec(t)))
                                        break;
                                    for (var b = k.index + (p ? k[1].length : 0), _ = k.index + k[0].length, x = y, C = v, T = e.length; x < T && (C < _ || !e[x].type && !e[x - 1].greedy); ++x)
                                        (C += e[x].length) <= b && (++y,
                                        v = C);
                                    if (e[y]instanceof M)
                                        continue;
                                ...
                                if (k) {
                                    p && (g = k[1] ? k[1].length : 0),
                                    _ = (b = k.index + g) + (k = k[0].slice(g)).length;
                                    var D = w.slice(0, b)
                                      , $ = w.slice(_)
                                      , w = [y, S];
                                    D && (++y,
                                    v += D.length,
                                    w.push(D));
                                    D = new M(a,u ? z.tokenize(k, u) : k,m,k,f);
                                    if (w.push(D),
                                    $ && w.push($),
                                    Array.prototype.splice.apply(e, w),
                                    1 != S && z.matchGrammar(t, e, i, y, v, !0, a),
                                    n)
                                        break
                                } else if (n)
                                    break
        ...
        tokenize: function(t, e) {
            ...
            return z.matchGrammar(t, i, e, 0, 0, !1),
            i
        },
        hooks: {
            all: {},
    ...
    if (l.Prism = z,
    M.stringify = function(t, e) {
        if ("string" == typeof t)
            return t;
        if (Array.isArray(t))
            return t.map(function(t) {
                return M.stringify(t, e)
            }).join("");
        var i = {
            type: t.type,
            content: M.stringify(t.content, e),
            tag: "span",
            classes: ["token", t.type],
            attributes: {},
            language: e
        };
        t.alias && (s = Array.isArray(t.alias) ? t.alias : [t.alias],
    ...
    ,
    !l.document)
        return l.addEventListener && (z.disableWorkerMessageHandler || l.addEventListener("message", function(t) {
    ...
    return t && (z.filename = t.src,
    z.manual || t.hasAttribute("data-manual") || ("loading" !== document.readyState ? window.requestAnimationFrame ? window.requestAnimationFrame(z.highlightAll) : window.setTimeout(z.highlightAll, 16) : document.addEventListener("DOMContentLoaded", z.highlightAll))),
    z
}(_self);
